...
//    readonly googleAdsClient: Customer;
...
// //    async makeGoogleAdsRequest(method: 'get' | 'post' | 'put' | 'delete', endpoint: string, data?: any): Promise<any> {
...
// //    async addKeywordsToAdGroup(adGroupResourceName: string, keywords: Array<{ text: string; matchType: string; bidAmount: number }>) {
// //     if (!keywords?.length) return;
...
//     location: { streetAddress: string; city: string; country: string; postalCode: string } | null = null,
...
//       // ✅ Create Ad Group
//       const adGroupResponse = await this.googleAdsClient.adGroups.create([
//         {
...
//         keyword: {
//           text: keyword.text,
//           match_type: keyword.matchType.toUpperCase(),
//         },
//         status: 'ENABLED',  // You can set a status here, e.g., 'ENABLED'
//         type: 'KEYWORD',    // Set the type as 'KEYWORD'
//       }));
      
//       await this.googleAdsClient.adGroupCriteria.create(adGroupCriteria);
      
//       // ✅ Create Ad
//       const adResponse = await this.googleAdsClient.adGroupAds.create([
//         {
//           ad_group: adGroupResourceName,
//           ad: {
//             final_urls: [finalUrl],
//             expanded_text_ad: {
//               headline_part1: headlines[0],
//               headline_part2: headlines[1],
//               headline_part3: headlines[2] || '',
...
//       if (!adResourceName) this.logger.warn('Ad creation successful but resource name not found.');
...
//         extensionOperations.push({
//           create: {
//             campaign: campaignResourceName,
//             extension_type: 'SITELINK',
//             sitelink: {
//               text: link.text,
//               final_urls: [link.finalUrl],
//             },
//           },
//         });
//       });
...
//               country_code: process.env.GOOGLE_ADS_COUNTRY_CODE || 'US',
//             },
//           },
//         });
//       }
...
//             location: {
//               business_name: process.env.GOOGLE_ADS_BUSINESS_NAME || 'Your Business',
//               address: {
...
//         await this.googleAdsClient.campaignExtensionSettings.mutate({
